...
## Precision matrices for spatio-temporal interaction (generic0)
R.1<- diag(n*t)
r.def.1<- 0
...
## save
save(model, file= paste0("resul/resul_Centered_Psplines_ps",ord.spat,"_pt",ord.temp,"_type",type,"_",gsub("\\.", "_", strategy),".RData"))
